...
public class MultiSkillController {
    ...
    @PostMapping("/doChatSalesAnalysis")
    public Map<String, Object> doChatSalesAnalysis(@Parameter(description = "用户消息") @RequestParam(name = "message") String message) {
        return multiSkillService.doChatSalesAnalysis(message);
    }
