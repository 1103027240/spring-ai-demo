    ...
    public AgentScopeRoutingAgent codeSearchRoutingAgent (
        ...
        return AgentScopeRoutingAgent.builder()
                ...
                .systemPrompt(
                    ...
                    路由规则：
                    1. 如果查询包含"GitHub"、"英文"、"国际"、"开源"等关键词，调用githubAgent
                    2. 如果查询包含"Gitee"、"中文"、"国内"、"企业"等关键词，调用giteeAgent  
                    3. 如果查询包含"博客"、"文章"、"教程"、"学习"等关键词，调用csdnAgent
                    4. 对于通用技术查询，可以同时调用一个或多个代理获取全面结果
