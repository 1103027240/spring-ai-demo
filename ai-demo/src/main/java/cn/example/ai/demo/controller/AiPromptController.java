...
public class AiPromptController {
    ...
    public Flux<String> doChatRoleSystem(
        ...
        return aiPromptService.doChatRoleSystem(msg);
    }
    ...
    public Flux<String> doChatRoleTool(
            ...
            @RequestParam(value = "msg") String msg){
        return aiPromptService.doChatRoleTool(msg);
    }
    ...
    public Flux<String> doChatRoleCombine(
            ...
            @RequestParam(value = "msg") String msg){
        return aiPromptService.doChatRoleCombine(msg);
    }
    ...
    public Student doChatOutput(
        ...
        return aiPromptService.doChatOutput(name, id, age, email);
    }
