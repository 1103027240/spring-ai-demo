...
import cn.example.ai.demo.node.document.*;
import cn.example.ai.demo.node.document.*;
...
import static cn.example.ai.demo.constant.WorkflowConstant.DOCUMENT_REVIEW_NAME;
import static cn.example.ai.demo.constant.WorkflowConstant.DOCUMENT_REVIEW_TITLE;
import static cn.example.ai.demo.enums.ApprovalDecisionEnum.APPROVE;
import static cn.example.ai.demo.enums.ApprovalDecisionEnum.REJECT;
import static cn.example.ai.demo.enums.DocumentReviewNodeEnum.*;
