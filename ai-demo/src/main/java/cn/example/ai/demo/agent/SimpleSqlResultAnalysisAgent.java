...
import static cn.example.ai.demo.enums.SqlQueryNodeEnum.ANALYSIS_NODE;

@Slf4j
@Component
public class SimpleSqlResultAnalysisAgent {
    ...
    @Autowired
    public SimpleSqlResultAnalysisAgent(@Qualifier("qwenAgentChatModel") Model qwenAgentChatModel) {
