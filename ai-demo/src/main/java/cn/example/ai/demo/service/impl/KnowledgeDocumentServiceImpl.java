...
import cn.example.ai.demo.build.KnowledgeDocumentSearchBuild;
import cn.example.ai.demo.build.KnowledgeDocumentBuild;
import cn.example.ai.demo.check.KnowledgeDocumentCheck;
import cn.example.ai.demo.entity.KnowledgeDocument;
import cn.example.ai.demo.enums.CursorSortByEnum;
import cn.example.ai.demo.enums.KnowledgeDocumentStatusEnum;
import cn.example.ai.demo.mapper.KnowledgeDocumentMapper;
...
import static cn.example.ai.demo.constant.RedisKeyConstant.*;
import static cn.example.ai.demo.enums.SortDirectionEnum.DESC;
